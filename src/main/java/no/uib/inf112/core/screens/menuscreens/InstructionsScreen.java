...
public class InstructionsScreen extends AbstractMenuScreen {

    public InstructionsScreen(GameGraphics game) {
        super(game);
    ...
    @Override
    public void show() {
        String instructions = "- Click and drag cards into your chosen registers\n" +
                ...
                "- Konami code is fun";
        Label instruction = game.createLabel(instructions, stage.getWidth() / 8, stage.getHeight() / 3, 30);

 ...
 * @author Elg
 */
public abstract class AbstractMultiDirectionalActionTile<T extends Tile> extends AbstractActionTile<T> implements MultiDirectionalTile {

    private Set<Direction> dirs;

    public AbstractMultiDirectionalActionTile(Vector2Int pos, TileGraphic tg) {
        super(pos, tg);

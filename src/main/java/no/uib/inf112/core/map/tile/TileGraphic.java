...
public enum TileGraphic {
    ...
    WALL_NORTH_WITH_DOUBLE_LASER(94, TileType.WALL, DIR_NORTH, SHOOTS_LASER, DOUBLE_LASER),

    WALL_EAST(23, TileType.WALL, DIR_EAST),
    WALL_EAST_WITH_LASER(46, TileType.WALL, DIR_EAST, SHOOTS_LASER),
    WALL_EAST_WITH_DOUBLE_LASER(95, TileType.WALL, DIR_EAST, SHOOTS_LASER, DOUBLE_LASER),

    WALL_WEST(30, TileType.WALL, DIR_WEST),
    WALL_WEST_WITH_LASER(38, TileType.WALL, DIR_WEST, SHOOTS_LASER),
    WALL_WEST_WITH_DOUBLE_LASER(93, TileType.WALL, DIR_WEST, SHOOTS_LASER, DOUBLE_LASER),

    WALL_SOUTH(29, TileType.WALL, DIR_SOUTH),
    WALL_SOUTH_WITH_LASER(37, TileType.WALL, DIR_SOUTH, SHOOTS_LASER),
    WALL_SOUTH_WITH_DOUBLE_LASER(87, TileType.WALL, DIR_SOUTH, SHOOTS_LASER, DOUBLE_LASER),

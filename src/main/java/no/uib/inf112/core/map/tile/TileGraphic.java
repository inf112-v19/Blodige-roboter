...
public enum TileGraphic {
    ...
    CONVEYOR_FROM_WEST_GO_NORTH(57, TileType.ROTATION_CONVEYOR, DIR_NORTH, LEFT, WEST_NORTH),
    CONVEYOR_FROM_NORTH_GO_EAST(58, TileType.ROTATION_CONVEYOR, DIR_EAST, LEFT, NORTH_EAST),
    CONVEYOR_FROM_EAST_GO_SOUTH(59, TileType.ROTATION_CONVEYOR, DIR_SOUTH, LEFT, EAST_SOUTH),
    CONVEYOR_FROM_SOUTH_GO_WEST(60, TileType.ROTATION_CONVEYOR, DIR_WEST, LEFT, SOUTH_WEST),
    ...
    CONVEYOR_FROM_EAST_GO_NORTH(65, TileType.ROTATION_CONVEYOR, DIR_NORTH, RIGHT, EAST_NORTH),
    CONVEYOR_FROM_SOUTH_GO_EAST(66, TileType.ROTATION_CONVEYOR, DIR_EAST, RIGHT, SOUTH_EAST),
    CONVEYOR_FROM_WEST_GO_SOUTH(67, TileType.ROTATION_CONVEYOR, DIR_SOUTH, RIGHT, WEST_SOUTH),
    CONVEYOR_FROM_NORTH_GO_WEST(68, TileType.ROTATION_CONVEYOR, DIR_WEST, RIGHT, NORTH_WEST),
    ...
    EXPRESS_CONVEYOR_FROM_WEST_GO_NORTH(73, TileType.ROTATION_CONVEYOR, HIGH_PRIORITY, DIR_NORTH, LEFT, WEST_NORTH),
    EXPRESS_CONVEYOR_FROM_NORTH_GO_EAST(74, TileType.ROTATION_CONVEYOR, HIGH_PRIORITY, DIR_EAST, LEFT, NORTH_EAST),
    EXPRESS_CONVEYOR_FROM_EAST_GO_SOUTH(75, TileType.ROTATION_CONVEYOR, HIGH_PRIORITY, DIR_SOUTH, LEFT, EAST_SOUTH),
    EXPRESS_CONVEYOR_FROM_SOUTH_GO_WEST(76, TileType.ROTATION_CONVEYOR, HIGH_PRIORITY, DIR_WEST, LEFT, SOUTH_WEST),
    ...
    EXPRESS_CONVEYOR_FROM_EAST_GO_NORTH(77, TileType.ROTATION_CONVEYOR, HIGH_PRIORITY, DIR_NORTH, RIGHT, EAST_NORTH),
    EXPRESS_CONVEYOR_FROM_SOUTH_GO_EAST(78, TileType.ROTATION_CONVEYOR, HIGH_PRIORITY, DIR_EAST, RIGHT, SOUTH_EAST),
    EXPRESS_CONVEYOR_FROM_WEST_GO_SOUTH(86, TileType.ROTATION_CONVEYOR, HIGH_PRIORITY, DIR_SOUTH, RIGHT, WEST_SOUTH),
    EXPRESS_CONVEYOR_FROM_NORTH_GO_WEST(83, TileType.ROTATION_CONVEYOR, HIGH_PRIORITY, DIR_WEST, RIGHT, NORTH_WEST),
    EXPRESS_CONVEYOR_FROM_EAST_AND_WEST_GO_NORTH(82, TileType.ROTATION_CONVEYOR, HIGH_PRIORITY, DIR_NORTH, WEST_NORTH, EAST_NORTH),

...
public enum TileGraphic {
    ...
    VOID_WITH_WARING_NOT_LEFT(109, TileType.VOID),
    VOID_WITH_WARING_NOT_RIGHT(117, TileType.VOID),
    VOID_WITH_WARING_NOT_UP(110, TileType.VOID),
    VOID_WITH_WARING_NOT_DOWN(118, TileType.VOID),
    ...
    CONVEYOR_RIGHT_DOUBLE_STEP(14, TileType.CONVEYOR),
    CONVEYOR_LEFT_DOUBLE_STEP(22, TileType.CONVEYOR),
    CONVEYOR_UP_DOUBLE_STEP(13, TileType.CONVEYOR),
    CONVEYOR_DOWN_DOUBLE_STEP(21, TileType.CONVEYOR),
    CONVEYOR_FROM_LEFT_GO_UP_DOUBLE_STEP(73, TileType.CONVEYOR),
    CONVEYOR_FROM_TOP_GO_RIGHT_DOUBLE_STEP(74, TileType.CONVEYOR),
    CONVEYOR_FROM_RIGHT_GO_DOWN_DOUBLE_STEP(75, TileType.CONVEYOR),
    CONVEYOR_FROM_BOTTOM_GO_LEFT_DOUBLE_STEP(76, TileType.CONVEYOR),
    CONVEYOR_FROM_TOP_AND_BOTTOM_GO_RIGHT_DOUBLE_STEP(81, TileType.CONVEYOR),
    CONVEYOR_FROM_LEFT_AND_RIGHT_GO_DOWN_DOUBLE_STEP(82, TileType.CONVEYOR),
    CONVEYOR_FROM_RIGHT_GO_UP_DOUBLE_STEP(77, TileType.CONVEYOR),
    CONVEYOR_FROM_BOTTOM_GO_RIGHT_DOUBLE_STEP(78, TileType.CONVEYOR),
    CONVEYOR_FROM_LEFT_GO_DOWN_DOUBLE_STEP(86, TileType.CONVEYOR),
    CONVEYOR_FROM_TOP_GO_LEFT_DOUBLE_STEP(83, TileType.CONVEYOR),
    CONVEYOR_FROM_RIGHT_AND_LEFT_GO_UP_DOUBLE_STEP(82, TileType.CONVEYOR),
    CONVEYOR_FROM_TOP_AND_BOTTOM_GO_LEFT_DOUBLE_STEP(83, TileType.CONVEYOR),
    ...
    CONVEYOR_FROM_RIGHT_TURN_DOWN_DOUBLE_STEP(19, TileType.CONVEYOR),
    CONVEYOR_FROM_TOP_TURN_RIGHT_DOUBLE_STEP(25, TileType.CONVEYOR),
    CONVEYOR_FROM_LEFT_TURN_UP_DOUBLE_STEP(26, TileType.CONVEYOR),
    CONVEYOR_FROM_BOTTOM_TURN_LEFT_DOUBLE_STEP(18, TileType.CONVEYOR),
    CONVEYOR_FROM_BOTTOM_TURN_RIGHT_DOUBLE_STEP(19, TileType.CONVEYOR),
    CONVEYOR_FROM_LEFT_TURN_DOWN_DOUBLE_STEP(20, TileType.CONVEYOR),
    CONVEYOR_FROM_TOP_TURN_LEFT_DOUBLE_STEP(28, TileType.CONVEYOR),
    CONVEYOR_FROM_RIGHT_TURN_UP_DOUBLE_STEP(26, TileType.CONVEYOR);
